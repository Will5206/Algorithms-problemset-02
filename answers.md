...
**Name:**___WILL SILVER WAGMAN


Place all written answers from `problemset-02.md` here for easier grading.

Note: i accidentally types all my answers in the problemset-02.md file, so i've just copied and pasted them here into answers.md
